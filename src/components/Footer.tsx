      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 mb-6">
            {['Home', 'About', 'Skills', 'Projects', 'Awards', 'Contact'].map((item, index) => (
              <a
                key={item}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            <a href="mailto:quachtailoi@gmail.com" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center">
              <span className="w-2 h-2 bg-primary rounded-full mr-2"></span>
              quachtailoi@gmail.com
            </a>
            <a href="tel:+84123456789" className="text-sm text-gray-400 hover:text-white transition-colors flex items a center">
              <span className="w-2 h-2 bg-primary rounded-full mr-2"></span>
              +84 123 456 789
            </a>
          </div>
