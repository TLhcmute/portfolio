        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-300">
              Xin chào! Tôi là Quách Tài Lợi, sinh viên năm nhất tại Đại học Sư
              phạm Kỹ thuật TP.HCM (HCMUTE). Tôi có niềm đam mê với lập trình
              web và phát triển ứng dụng, đặc biệt là các công nghệ frontend và
              backend hiện đại.
            </p>
            <p className="text-lg text-gray-300">
              Với nền tảng kiến thức vững chắc về JavaScript/TypeScript, tôi đã
              tập trung vào việc phát triển các ứng dụng web sử dụng ReactJS,
              NextJS ở frontend và Node.js, Express, NestJS ở backend.
            </p>
            <p className="text-lg text-gray-300">
              Tôi luôn tìm kiếm cơ hội để trau dồi kỹ năng và thách thức bản
              thân qua các dự án thực tế và hackathon, như giải Ba tại Hackathon
              UTE mở rộng 2025.
            </p>
          </div>
            ...
            <Card className="bg-secondary/50 border border-secondary hover:border-primary transition-all">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-primary mt-2 font-medium">GPA: 3.2</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Phát triển giải pháp công nghệ sáng tạo
                  </p>
                </div>
              </CardContent>
            </Card>
